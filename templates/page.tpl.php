        ...
        <?php if (!empty($page['header'])): ?>
          ...
          <section class="l-header-region row">
            <!-- <div class="rows"> -->
              ...
              <div class="columns small-12 logo-wrapper">
                
                <div class="columns small-10 medium-8 large-8">
                  <?php if ($linked_logo): print $linked_logo; endif; ?>
                </div>
                
                <nav class="tab-bar small-2 medium-2 large-2 columns hide-for-large-up">
